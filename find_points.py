...
def find_4_point(ori_image):
    ...
    def Harris_corner(ori_image, edg_img):
        ...
        return res, point_selection #return result image
    #-------------------------------------------------------#
    ...
    res, point_selection = Harris_corner(ori_image, seg_obj)# find the corner for the pool table
    #-------------------------------------------------------#   
  
    return res, point_selection
